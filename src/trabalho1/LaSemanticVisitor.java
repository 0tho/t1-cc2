...
public class LaSemanticVisitor extends LaParserBaseVisitor<Object> {
  ...
  public static HashMap<String, Tipo> tipos;
  public static LinkedList<HashMap<String, Simbolo>> pilha;
  ...
  public static boolean pilhaContemSimbolo(String simboloId) {
    for( HashMap<String, Simbolo> tabela : pilha ) {
  ...
  public static boolean checarSePilhaContemSimbolo(String ident, int linha) {
  ...
  public static boolean checarSePilhaContemSimbolo(Token ident) {
    return checarSePilhaContemSimbolo(ident.getText(), ident.getLine());
  }

  public static boolean checarSePilhaContemSimbolo(Simbolo simbolo) {
  ...
  public static Simbolo pegarSimbolo(Token id) {
  ...
  public static Simbolo pegarSimbolo(String id) {
